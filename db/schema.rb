...
ActiveRecord::Schema.define(version: 20_200_320_103_726) do
  ...
  create_table 'trade_certificates', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['owner_id'], name: 'index_trade_certificates_on_owner_id'
  end

  add_foreign_key 'active_storage_attachments', 'active_storage_blobs', column: 'blob_id'
  add_foreign_key 'owners', 'businesses'
  add_foreign_key 'passports', 'owners'
  add_foreign_key 'trade_certificates', 'owners'
end
